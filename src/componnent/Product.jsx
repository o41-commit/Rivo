    ...
    <div className="px-5 md:px-8 lg:px-12 py-8 md:py-12 bg-gradient-to-b from-white to-green-50">
      ...
      <div className="text-center max-w-2xl md:max-w-3xl mx-auto mb-12 md:mb-16">
        ...
        <p className="text-gray-600 mt-4 text-sm sm:text-base md:text-lg leading-relaxed">
          Explore our latest collection of modern, comfortable, and stylish clothing.
          Designed to fit your everyday lifestyle while keeping you confident and unique.
        </p>
