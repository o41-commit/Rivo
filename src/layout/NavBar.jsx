      ...
      <div className="bg-[#C2EFD4] fixed top-0 left-0 w-full z-[999] border-b border-[#224F34] text-[#224F34]">
        <div className="flex justify-between items-center px-4 py-3 md:py-4">
          ...
          <div className="flex items-center gap-6 md:gap-8">
            <Link to="/search" className="p-2 md:p-3">
              <IoSearchOutline className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl" />
            </Link>

            <Link to="/cart" className="relative p-2 md:p-3">
              <IoCartOutline className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl" />

              <div className="absolute top-1 right-1 md:top-2 md:right-2 w-3 h-3 md:w-4 md:h-4 rounded-full bg-green-900"></div>
            </Link>
          </div>
        </div>
      </div>
