...
const Cart = () => {
  ...
  const updateItem = async (id, newQuantity) => {
    ...
    try {
      const res = await fetch("https://rivo-ecommerce-db.onrender.com/cart/edit", {
        method: "PATCH",
  ...
  const deleteItem = async (id) => {
    try {
      const res = await fetch(`https://rivo-ecommerce-db.onrender.com/cart/delete/${id}`, {
        method: "DELETE",
      });
          ...
          >
            ...
            <div className="flex-1 flex flex-col md:flex-row md:justify-between md:items-center w-full">
              ...
              <button
                ...
                className="text-red-500 mt-3 md:mt-0 md:ml-4 self-end"
              >
